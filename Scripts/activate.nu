...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Bumblebee\Desktop\Udagram-Uwem\image-filter-starter-code'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Bumblebee\Desktop\Udagram-Uwem\image-filter-starter-code\Scripts\deactivate.nu'
